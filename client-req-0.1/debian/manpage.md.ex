% client-req(SECTION) | User Commands
%
% "January 22 2024"
...
client-req - program to do something

# SYNOPSIS

**client-req** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**client-req** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **client-req** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**client-req** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    client-req. See **foo.conf**(5) for further details.
...
**client-req** provides some return codes, that can be used in scripts:
